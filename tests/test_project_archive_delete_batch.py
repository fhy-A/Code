...
def test_project_archive_delete_in_isolated_process():
    with tempfile.TemporaryDirectory(prefix="code072-delete-cases-") as directory:
        ...
        result = subprocess.run([
            ...
            "tests/project_archive_delete_cases.py", "-q", "--tb=short", "-p", "no:cacheprovider",
