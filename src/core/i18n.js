(function initializeCodeI18n(global) {
  ...
  const I18N = {
    zh: {
      ...
      processingLabel: "处理中", waitingForModelResponse: "已提交模型，正在等待首个响应", modelResponseDelayed: "模型仍在处理，首个响应尚未到达", modelResponseSlow: "上游响应较慢，可能正在重试，可随时停止", modelRecovery: "模型未给出有效结果，正在自动续行（{attempt}/{max}）", networkRecovering: "网络恢复中", networkReconnectStatus: "网络连接已中断，正在自动恢复 · 已尝试 {attempt} 次 · ", networkReconnectSuffix: " 后重试", completedLabel: "完成",
    ...
    en: {
      ...
      processingLabel: "Working", waitingForModelResponse: "Request sent. Waiting for the first model response.", modelResponseDelayed: "The model is still working; the first response has not arrived.", modelResponseSlow: "The upstream is responding slowly and may be retrying. You can stop at any time.", modelRecovery: "The model returned no usable result. Continuing automatically ({attempt}/{max}).", networkRecovering: "Reconnecting", networkReconnectStatus: "Connection lost. Recovering automatically · Attempt {attempt} · retry in ", networkReconnectSuffix: "", completedLabel: "Completed",
