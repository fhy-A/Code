(function initializeCodeI18n(global) {
  ...
  const I18N = {
    ...
    en: {
      ...
      toolProcessTitle: "Tool activity", toolProcessPreparing: "Preparing tool calls", toolProcessWaitingForModel: "Tools finished. Waiting for the model to continue.", toolProcessOperationCount: "{count} operations", toolProcessFailureCount: "{count} failed", toolProcessRunning: "Running", toolProcessSucceeded: "Succeeded", toolProcessFailed: "Failed", toolProcessCompleted: "Completed", toolProcessPending: "Pending", toolProcessModelNote: "Model note", toolProcessRepeated: "{count} consecutive attempts", toolProcessArguments: "Call arguments", toolProcessResult: "Execution result",
