(function initializeCodeI18n(global) {
  ...
  const I18N = {
    zh: {
      ...
      cmdGoalDesc: "查询 Goal，或创建等待确认的 3～8 步 Goal 草案",
      goalNoCurrent: "当前会话没有 Goal", goalDraftConfirm: "请确认这份 Goal 草案。确认后只激活 Goal，不会自动开始任务：", goalAwaitingConfirmation: "Goal 草案已保存，仍在等待确认", goalActivated: "Goal 已激活；本阶段不会自动续跑", goalPaused: "Goal 已暂停", goalResumed: "Goal 已恢复；本阶段不会自动续跑", goalChangeConfirm: "请确认以下 Goal 变更：", goalChangeBefore: "变更前", goalChangeAfter: "变更后", goalCancelConfirm: "确认取消当前 Goal？取消后仍保留历史。", goalClearConfirm: "确认清除当前 Goal？这会写入 tombstone，历史 ID 不会复用。", goalChangeNotApplied: "Goal 变更未确认，未写入", goalChanged: "Goal 变更已确认并写入", goalDraftAlreadyExists: "当前会话已有等待确认的 Goal 草案；请先查看并确认、修改、取消或清除该草案", goalAlreadyExists: "当前会话已有未结束 Goal；请先查看、修改、取消或清除当前 Goal", goalActionInProgress: "Goal 操作正在处理，请稍候", goalStructuredRevisionInvalid: "Goal 修改必须是包含 objective 和/或 3～8 个 steps 的 JSON 对象", goalActionFailed: "Goal 操作失败：{error}",
