(function initializeCodeI18n(global) {
  ...
  const I18N = {
    zh: {
      ...
      processingLabel: "处理中", waitingForModelResponse: "正在等待模型响应", modelResponseSlow: "上游响应较慢，可能正在重试，可随时停止", networkRecovering: "网络恢复中", networkReconnectStatus: "网络连接已中断，正在自动恢复 · 已尝试 {attempt} 次 · ", networkReconnectSuffix: " 后重试", completedLabel: "完成",
    ...
    en: {
      ...
      processingLabel: "Working", waitingForModelResponse: "Waiting for the model", modelResponseSlow: "The upstream is responding slowly and may be retrying. You can stop at any time.", networkRecovering: "Reconnecting", networkReconnectStatus: "Connection lost. Recovering automatically · Attempt {attempt} · retry in ", networkReconnectSuffix: "", completedLabel: "Completed",
