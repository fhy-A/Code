(function initializeCodeI18n(global) {
  ...
  const I18N = {
    zh: {
      ...
      cmdCompactDesc: "将较早对话压缩为摘要，保留最近上下文", cmdExportDesc: "导出对话为 Markdown 文件", cmdClearDesc: "清空当前会话，开始新对话", cmdBranchDesc: "从当前位置创建会话分支",
    ...
    en: {
      ...
      cmdCompactDesc: "Summarize earlier messages and keep recent context", cmdExportDesc: "Export chat as Markdown", cmdClearDesc: "Clear session, start new", cmdBranchDesc: "Create a branch from here",
