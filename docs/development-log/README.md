...
| 日期或范围 | 摘要 | 详细记录 |
|---|---|---|
| 2026-08-01 | v0.5.31 发布前状态与文档收口；AgentRun 90% 自动上下文压缩、任务中途续行与执行轨迹投影；workbar 用户端与品牌部署整合；`/compact` 手动压缩命令与命令/Skills 分组；app.js 第五阶段 5E/5F 收口 | [查看](2026/2026-08-01.md) |
