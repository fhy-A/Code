...
| 日期或范围 | 摘要 | 详细记录 |
|---|---|---|
| 2026-08-01 | app.js 阶段 6A/6B esbuild 构建链、显式 bundle 预览与人工验收，第五阶段 5G 与阶段 5 正式收口；Hermes PATH 冲突诊断与 Code Dev 托盘恢复；v0.5.31 端口隔离人工确认与发布前收口；AgentRun 90% 自动上下文压缩、任务中途续行与执行轨迹投影；workbar 用户端与品牌部署整合；`/compact` 手动压缩命令与命令/Skills 分组 | [查看](2026/2026-08-01.md) |
