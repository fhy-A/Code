...
> 状态：阶段 1 至 5 已完成；阶段 6 的 6A 至 6C 已完成，6D 等待首个 bundle 正式版本稳定后再评估
> 适用范围：Code 前端  
...
3. 当前已发布的正式 EXE 仍是此前的经典入口版本；本地新构建 EXE 已包含 bundle、经典页面和原始脚本。首个 bundle 正式版本稳定至少一个版本后，再评估 6D 清理兼容层，TypeScript 继续后置。
